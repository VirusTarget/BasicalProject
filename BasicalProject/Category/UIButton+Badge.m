...
- (void)updateBadgeFrame
{
    ...
    CGFloat middle =   (minWidth-minHeight)/2;
    self.badge.frame = CGRectMake(self.badgeOriginX-middle, self.badgeOriginY, minWidth + padding, minHeight + padding);
...
-(CGFloat) badgeOriginX {
    return CGRectGetWidth(self.imageView.frame)+self.imageView.frame.origin.x-5;
}
...
-(CGFloat) badgeOriginY {
    return self.imageView.frame.origin.y-5;
}
